...
export const Footer = () => {
  ...
  return (
    <footer className="border-t bg-[#FFF3E0] text-gray-800">
          ...
          >
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:border-red-500"
              />
              <button
                type="submit"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="space-y-3">
              <a href="tel:108" className="flex items-center gap-3 transition-colors group text-gray-500 hover:text-red-500">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-red-50 group-hover:bg-red-100">
              ...
              <a href="mailto:help@sevalinkcare.com" className="flex items-center gap-3 transition-colors group text-gray-500 hover:text-red-500">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-red-50 group-hover:bg-red-100">
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-sm transition-colors inline-flex items-center group text-gray-500 hover:text-red-500"
                    >
                      {link.name}
          ...
          <div className="flex items-center gap-2">
            {socialLinks.map((social) => (
              <motion.a
                ...
                className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-gray-200 hover:bg-red-50 text-gray-600 hover:text-red-500"
