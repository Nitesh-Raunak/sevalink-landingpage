...
export const metadata = {
  ...
  description:
    "Permanently delete your SevaLink account and all associated personal data. No login required. Google Play compliant. Request processed within 24–72 hours.",
